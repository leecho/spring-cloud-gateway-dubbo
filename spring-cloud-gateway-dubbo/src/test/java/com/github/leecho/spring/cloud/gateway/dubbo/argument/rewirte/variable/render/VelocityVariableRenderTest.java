...
class VelocityVariableRenderTest {
	...
	void render() {
		...
		Map<String, Object> result = rewriterRender.render(arguments, variableRenderContext);
	...
	void renderSample() {
		...
		Map<String, Object> result = rewriterRender.render(template, variableRenderContext);
		System.out.println(result);
